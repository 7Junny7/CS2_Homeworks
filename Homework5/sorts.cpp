...
int main()
{
    ...
    // destruction time.
    {
        ...
        for (int i=0; i<temp_sensor.size(); i++){
            sensors.at(i) = *temp_sensor.at(i);
        }
